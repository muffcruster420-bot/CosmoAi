...
CosmoAi lets anyone see how big the universe really is — from Planck scale (10⁻³⁵ m) to the observable universe (10²⁷ m) — and watch it unfold in front of them.
...
git commit -m "CosmoAi v0.1 - Universe Sandbox"
git push
```
...
This is v0.1 — the foundation. Next: connect real FITS files, add gravitational lensing inversion, train on SDSS data.
